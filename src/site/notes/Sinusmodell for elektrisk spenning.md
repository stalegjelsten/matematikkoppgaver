---
{"tags":["oppgave"],"date":"2025-11-17","modified":"2026-03-17","aliases":[],"dg-publish":true,"temaer":["regresjon","trigonometri","integral"],"fag":["r2"],"eksamen":"h25","del":2,"oppgave":2,"poeng":6,"oppgavenummer":[{"fag":"r2","del":2,"oppgave":2}],"title":"Sinusmodell for elektrisk spenning","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":3,"beskrivelse":"Sinusregresjon på spenningsmålinger, løse trigonometrisk likning, og bruke effektivverdi-formel for å verifisere målingene.","deloppgaver":[{"deloppgave":"a","kategori":1,"vanskegrad":1,"beskrivelse":"Sinusregresjon `RegSin` i GeoGebra og forenkling til $U(t) \\approx 323\\sin(100\\pi t)$."},{"deloppgave":"b","vanskegrad":2,"beskrivelse":"Løse $323\\sin(100\\pi t) = 230$ i $[0, 0{,}02]$ med arcsin og supplementvinkel."},{"deloppgave":"c","kategori":3,"beskrivelse":"Regne effektivverdi via identiteten $\\int_0^T \\sin^2(\\omega t)\\,dt = T/2$ og sammenligne med nettspenning 230 V."}],"dg-permalink":"/sinusmodell-for-elektrisk-spenning/","permalink":"/sinusmodell-for-elektrisk-spenning/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-11-17","modified":"2026-03-17","aliases":[],"temaer":["regresjon","trigonometri","integral"],"fag":["r2"],"eksamen":"h25","del":2,"oppgave":2,"poeng":6,"oppgavenummer":[{"fag":"r2","del":2,"oppgave":2}],"title":"Sinusmodell for elektrisk spenning","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":3,"beskrivelse":"Sinusregresjon på spenningsmålinger, løse trigonometrisk likning, og bruke effektivverdi-formel for å verifisere målingene.","deloppgaver":[{"deloppgave":"a","kategori":1,"vanskegrad":1,"beskrivelse":"Sinusregresjon `RegSin` i GeoGebra og forenkling til $U(t) \\approx 323\\sin(100\\pi t)$."},{"deloppgave":"b","vanskegrad":2,"beskrivelse":"Løse $323\\sin(100\\pi t) = 230$ i $[0, 0{,}02]$ med arcsin og supplementvinkel."},{"deloppgave":"c","kategori":3,"beskrivelse":"Regne effektivverdi via identiteten $\\int_0^T \\sin^2(\\omega t)\\,dt = T/2$ og sammenligne med nettspenning 230 V."}]}}
---
