---
{"tags":["oppgave"],"date":"2025-11-22","modified":"2026-01-16","aliases":[],"dg-publish":true,"temaer":["sannsynlighet","varians","forventningsverdi","diskrete sannsynlighetsfordelinger"],"fag":["s2"],"eksamen":"h25","del":1,"oppgave":4,"poeng":5,"oppgavenummer":[{"fag":"s2","del":1,"oppgave":4}],"title":"Sannsynlighet for poengtap ved poengspill","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":1,"beskrivelse":"Diskret sannsynlighetsfordeling fra 4-sidet terning; forventningsverdi med tolkning, og varians.","deloppgaver":[{"deloppgave":"a","kategori":1,"beskrivelse":"Fylle inn utfallsrom og $P(X=x)$ i tabell."},{"deloppgave":"b","beskrivelse":"Beregne $\\text{E}(X)=-0{,}5$ og tolke som gjennomsnittlig poengtap per omgang."},{"deloppgave":"c","kategori":1,"beskrivelse":"Beregne $\\text{Var}(X)=\\sum (x-\\text{E}(X))^2 P(X=x) = 5/4$."}],"dg-permalink":"/sannsynlighet-for-poengtap-ved-poengspill/","permalink":"/sannsynlighet-for-poengtap-ved-poengspill/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-11-22","modified":"2026-01-16","aliases":[],"temaer":["sannsynlighet","varians","forventningsverdi","diskrete sannsynlighetsfordelinger"],"fag":["s2"],"eksamen":"h25","del":1,"oppgave":4,"poeng":5,"oppgavenummer":[{"fag":"s2","del":1,"oppgave":4}],"title":"Sannsynlighet for poengtap ved poengspill","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":1,"beskrivelse":"Diskret sannsynlighetsfordeling fra 4-sidet terning; forventningsverdi med tolkning, og varians.","deloppgaver":[{"deloppgave":"a","kategori":1,"beskrivelse":"Fylle inn utfallsrom og $P(X=x)$ i tabell."},{"deloppgave":"b","beskrivelse":"Beregne $\\text{E}(X)=-0{,}5$ og tolke som gjennomsnittlig poengtap per omgang."},{"deloppgave":"c","kategori":1,"beskrivelse":"Beregne $\\text{Var}(X)=\\sum (x-\\text{E}(X))^2 P(X=x) = 5/4$."}]}}
---
