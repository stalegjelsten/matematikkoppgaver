...
>b) Bestem $x$ når $\int_0^x \sin\!\left(\pi t + \frac{\pi}{4}\right)dt = 0$ og $x \in \langle 0, \pi \rangle$.
>c) Gi en praktisk tolkning av svaret i oppgave b).

>[!question]- Fasit
>
>[[Løsningsforslag/Løsningsforslag R2 eksamen H2024#Oppgave 1-1\|Løsningsforslag R2 eksamen H2024#Oppgave 1-1]]
