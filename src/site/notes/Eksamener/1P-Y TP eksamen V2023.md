---
{"tags":["eksamen"],"fag":["1p-y tp"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y TP eksamen V2023","author":"matematikkoppgaver.vercel.app","dg-publish":true,"showheader":true,"contentClasses":"eksamen-side","dg-permalink":"/eksamener/1p-y-tp-eksamen-v2023/","permalink":"/eksamener/1p-y-tp-eksamen-v2023/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["eksamen"],"fag":["1p-y tp"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y TP eksamen V2023","author":"matematikkoppgaver.vercel.app","showheader":true,"contentClasses":"eksamen-side"}}
---
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/skyvelaere-aksel-og-toleransetabell/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Skyvelære aksel og toleransetabell

På bildet under ser du en måling av diameteren til en aksel med et skyvelære.

![Skyvelære](/img/user/_resources/1pytp-v23-1-4-1.jpeg){width=60%}

>[!oppgave]
>a) Hva er radiusen til akselen?

Tabellen under viser massetettheten til ulike metaller i $\mathrm{g/cm^3}$.

| Metall         | Tetthet ($\mathrm{g/cm^3}$) |
|----------------|------------------------------|
| aluminium      | $2{,}7$                      |
| rustfritt stål | $8{,}1$                      |
| magnesium      | $1{,}7$                      |
...
Volumet til den ferdige akselen er $24 \mathrm{~cm^3}$, og den veier cirka $108 \mathrm{~g}$.

>[!oppgave]
>b) Forklar ved å bruke opplysningene i tabellen hvilket metall akselen er laget av.

Under ser du et utdrag av tabellen «NS-EN ISO 286-1:2010». I denne tabellen er toleransene gitt i mikrometer ($\mu\mathrm{m}$). ØA = øvre avvik i $\mu\mathrm{m}$, NA = nedre avvik i $\mu\mathrm{m}$.

![Toleransetabell](/img/user/_resources/1pytp-v23-1-4-2.jpeg){width=90%}

>[!oppgave]
>c) Du har en maskindel med en boring som er målsatt med angitt toleranse $\emptyset 15$ K7.
>
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/tank-for-skjaereolje-og-pumpe/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Tank for skjæreolje og pumpe

Under ser du en tank for oppbevaring av skjæreolje. Innvendig har tanken målene lengde $= 800 \mathrm{~mm}$, bredde $= 500 \mathrm{~mm}$ og høyde $= 250 \mathrm{~mm}$.

>[!oppgave]
>a) Hvor mange liter rommer tanken?

For å lage et system for å tømme tanken skal du montere sammen en elmotor og en pumpe som vist på tegningen. Diameteren til akselen på elmotoren er $23 \mathrm{~mm}$, og diameter på akselen til pumpa er $17{,}5 \mathrm{~mm}$. Alle målene på tegningen er i millimeter.

![Elmotor og pumpe](/img/user/_resources/1pytp-v23-2-2.jpeg){width=70%}
...
>[!oppgave]
>b) Hvor høy må braketten være?

For hver omdreining pumpa gjør, forflyttes det $0{,}4 \mathrm{~dl}$ væske. Omdreiningstallet regnes i omdreininger per minutt.

>[!oppgave]
>c) Hvilket omdreiningstall skal pumpa ha hvis den skal forflytte $80$ liter væske på $4$ minutter? Husk å begrunne svaret ditt.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/aksel-omdreiningstall-og-toleranseklasse/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
En aksel skal dreies ned til en diameter på $15 \mathrm{~mm}$.
...
>[!oppgave]
>a) Hva er omdreiningstallet når $d = 15 \mathrm{~mm}$ og $v = 80 \mathrm{~m/min}$?

Akselen skal dreies etter kravet i toleranseklasse h5, som angir øvre avvik til $0 \; \mu\mathrm{m}$ og nedre avvik til $-8 \; \mu\mathrm{m}$.
...
|---------------------|-----------------------|
| linjal              | $0{,}5 \mathrm{~mm}$ |
| skyvelære           | $1/20 \mathrm{~mm}$  |
| mekanisk mikrometer | $1/100 \mathrm{~mm}$ |
| digitalt mikrometer | $1/1000 \mathrm{~mm}$ |

>[!oppgave]
>b) Forklar hvilke av måleverktøyene som kan brukes for å sjekke om akselens diameter oppfyller kravene til toleranseklasse h5.

Lengden av akselen er $50 \mathrm{~mm}$. Den måles med et måleverktøy som har en målenøyaktighet på $\pm 0{,}1 \mathrm{~mm}$.

>[!oppgave]
>c) Regn ut den absolutte usikkerheten og den relative usikkerheten til denne målingen.
