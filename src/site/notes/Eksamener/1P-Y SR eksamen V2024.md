---
{"tags":["eksamen"],"fag":["1p-y sr"],"eksamen":"v24","date":"2024-05-23","del1_tid":1,"del2_tid":3,"title":"1P-Y SR eksamen V2024","author":"matematikkoppgaver.vercel.app","dg-publish":true,"showheader":true,"contentClasses":"eksamen-side","dg-permalink":"/eksamener/1p-y-sr-eksamen-v2024/","permalink":"/eksamener/1p-y-sr-eksamen-v2024/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["eksamen"],"fag":["1p-y sr"],"eksamen":"v24","date":"2024-05-23","del1_tid":1,"del2_tid":3,"title":"1P-Y SR eksamen V2024","author":"matematikkoppgaver.vercel.app","showheader":true,"contentClasses":"eksamen-side"}}
---
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/merverdiavgift-pa-klaer-tone-og-kare/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Merverdiavgift på klær Tone og Kåre
...
>[!oppgave]
>a) Hva er prisen med merverdiavgift?
...
>[!oppgave]
>b) Vurder om det er Kåre eller ekspeditøren som har rett. Husk å begrunne svaret ditt.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/ulrik-kantine-gjennomsnitt-og-median/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Ulrik kantine gjennomsnitt og median
...
>[!blue-box] Ulrik
>Hva er medianen for hvor mye kundene handlet for?
>
>Hva er størst av gjennomsnittet og medianen?
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/t-skjorter-ungdomsbedrift-og-fortjeneste/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# T-skjorter ungdomsbedrift og fortjeneste
...
| Vare      | Kostpris | Salgspris |
|-----------|----------|-----------|
| T-skjorte | 105 kr   | 199 kr    |

>[!oppgave]
>a) Hvor mange prosent fortjenestemargin har bedriften på salg av T-skjorter?

Bedriften har laget denne oversikten for april:

| Kostpris T-skjorte  | 105 kr |
|---------------------|--------|
| Salgspris T-skjorte | 199 kr |
| Solgte T-skjorter   | 240    |
| Arbeidstimer        | 160    |

**Fakta:** fortjeneste = inntekter – kostnader

>[!oppgave]
>b) Bruk regneark til å regne ut
...
>[!oppgave]
>c) Hvor mange T-skjorter må ungdomsbedriften selge i mai for å få samme fortjeneste som i april?
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/persontransport-i-norge-1980-2022/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Persontransport i Norge 1980–2022
...
| Persontransport etter transportmåte | Passasjerkilometer (alle tall i millioner) |        |        |        |        |
|--------------------------------------|--------------------------------------------|--------|--------|--------|--------|
|                                      | 1980                                       | 1990   | 2000   | 2010   | 2022   |
| Sjøtransport                         | 660                                        | 694    | 845    | 929    | 1 148  |
| Skinnegående transport               | 2 751                                      | 2 430  | 3 353  | 3 683  | 3 782  |
| Veitransport                         | 35 819                                     | 48 092 | 56 358 | 64 081 | 63 897 |
| Lufttransport                        | 1 475                                      | 2 665  | 4 415  | 5 182  | 5 169  |

Elevene tenker på hva de skal gjøre med informasjonen i tabellen:

>[!blue-box] Elevene
>Vi velger to av de fire transportmåtene og lager en grafisk framstilling som viser utviklingen fra 1980 til 2022. Hva viser framstillingen om utviklingen for de to transportmåtene?
>
>Vi vil sammenlignet årene 1980 og 2022. Hvor stor har endringen vært for hver av de fire typene transport? Hvilken transportmåte har hatt den største økningen?

Elevene finner også statistikk for antall innbyggere i Norge, og stiller flere spørsmål:

| Årstall              | 1980      | 2022      |
|----------------------|-----------|-----------|
| Befolkning 1. januar | 4 078 900 | 5 425 270 |

>[!blue-box] Elevene
>Nordmenn reiste til sammen 63 897 millioner kilometer med veitransport i 2022. Hvor mange kilometer reiste hver person i Norge i gjennomsnitt med veitransport det året? Reiste hver person mer med veitransport i 2022 enn i 1980?
