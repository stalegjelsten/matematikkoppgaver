---
{"tags":["eksamen"],"fag":["1p-y hs"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y HS eksamen V2023","author":"matematikkoppgaver.vercel.app","dg-publish":true,"showheader":true,"contentClasses":"eksamen-side","dg-permalink":"/eksamener/1p-y-hs-eksamen-v2023/","permalink":"/eksamener/1p-y-hs-eksamen-v2023/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["eksamen"],"fag":["1p-y hs"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y HS eksamen V2023","author":"matematikkoppgaver.vercel.app","showheader":true,"contentClasses":"eksamen-side"}}
---
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/prisformel-sparkesykkel/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/sammenligne-priser-pa-hundemat/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/prosentvis-prisforskjell-sjokolade/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/barnehage-aldersfordeling-og-bemanning/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Barnehage aldersfordeling og bemanning

Diagrammet under viser aldersfordelingen for barna i Grønnskogen barnehage.

![Aldersfordeling](/img/user/_resources/1pyhs-v23-1-4.jpeg){width=70%}

>[!oppgave]
>a) Hvor mange barn i Grønnskogen barnehage er 3 år eller eldre?

Minimumskravet til antall voksne som jobber i en barnehage, kan regnes ut ved å bruke formelen

$$V = \frac{2a + b}{6}$$

$V$ er antall voksne, $a$ er antall barn under tre år og $b$ er antall barn over tre år.

I Fuglereir barnehage er det 15 barn under tre år og 30 barn over tre år.

>[!oppgave]
>b) Hvor mange voksne må Fuglereir barnehage ha for å oppfylle minimumskravet?

I Lilleputt barnehage er alle barna under tre år.

>[!oppgave]
>c) Bruk formelen til å finne ut hvor mange barn under tre år barnehagen maksimalt kan ha per voksen.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/helsefagarbeidere-kvinner-og-menn/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Helsefagarbeidere kvinner og menn

Tabellen viser antall kvinner og menn med jobb som helsefagarbeider i Norge for årene 2017–2021.

| Årstall | 2017   | 2018   | 2019   | 2020   | 2021   |
|---------|--------|--------|--------|--------|--------|
| Kvinner | 22 591 | 24 837 | 27 713 | 30 297 | 33 184 |
| Menn    | 3 310  | 3 707  | 4 396  | 5 117  | 5 978  |

>[!oppgave]
>a) Lag en grafisk framstilling som presenterer dataene i tabellen over på en oversiktlig måte.
...
| Helsefagarbeidere | 2017 | 2021 | Økning | Økning i % |
|-------------------|------|------|--------|------------|
| Menn              | 3310 | 5978 | 2668   | 44,6 %     |

>[!oppgave]
>b) Eleven har gjort en feil. Forklar feilen eleven har gjort, og gjør utregninger slik at du finner riktig svar.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/hjemmetjeneste-og-medisindispensere/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Hjemmetjeneste og medisindispensere
...
![Sektordiagram](/img/user/_resources/1pyhs-v23-2-2.jpeg){width=60%}

I kommunen er det $1340$ brukere som får besøk 7 dager per uke.

>[!oppgave]
>a) Hvor mange brukere er det totalt i denne kommunen?

I en annen kommune er det $510$ eldre brukere som trenger besøk 7 dager per uke for å få hjelp til å ta medisin.

- Gjennomsnittlig tidsbruk per besøk er $30$ minutter.
- Hver bruker får totalt $30$ besøk i måneden.
- Lønnskostnadene er på $495$ kroner per time.

>[!oppgave]
>b) Lag et regneark som viser den samlede lønnskostnaden kommunen har for de $510$ brukerne per måned.

Kommunen ønsker å ta i bruk elektroniske medisindispensere for å redusere kostnader.

- Hver av de $510$ brukerne skal ha en elektronisk medisindispenser.
- En elektronisk medisindispenser koster $2200$ kroner per måned.
- Antall besøk reduseres med $80 \%$.

>[!oppgave]
>c) Utvid regnearket og bestem hvor mye kommunen sparer per måned ved å ta i bruk elektroniske medisindispensere.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/naeringsinnhold-og-energi-i-frokost/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Næringsinnhold og energi i frokost

Tabellen nedenfor viser næringsinnhold per $100 \mathrm{~g}$ matvare.

| Næringsinnhold | Grovbrød       | Kokt skinke   | Gulost        | Paprika       | Appelsinjuice |
|----------------|----------------|---------------|---------------|---------------|---------------|
| Energi (kcal)  | $226$ kcal     | $100$ kcal    | $370$ kcal    | $26$ kcal     | $43$ kcal     |
| Karbohydrater  | $35{,}3$ g     | $0{,}9$ g     | $0$ g         | $4{,}2$ g     | $9{,}6$ g     |
| Protein        | $10{,}5$ g     | $18$ g        | $25$ g        | $0{,}8$ g     | $0{,}6$ g     |
| Fett           | $3{,}3$ g      | $2{,}7$ g     | $30$ g        | $0{,}2$ g     | $0{,}2$ g     |

Energien i en matvare kan beregnes med formelen

$$E = 17K + 17P + 37F$$

I formelen er $E$ energi i kilojoule (kJ), $P$ antall gram proteiner, $K$ antall gram karbohydrater og $F$ antall gram fett.

Energien i $100 \mathrm{~g}$ kokt skinke er $421 \mathrm{~kJ}$.

>[!oppgave]
>a) Vis at formelen stemmer for $100 \mathrm{~g}$ kokt skinke.

En beboer på sykehjem har denne kostholdsplanen for frokost:

Mat: 2 brødskiver med kokt skinke, gulost og paprika

- 1 brødskive veier $45 \mathrm{~g}$
- 1 skive kokt skinke veier $12 \mathrm{~g}$
- 1 skive gulost veier $20 \mathrm{~g}$
- Paprika til 2 brødskiver veier $15 \mathrm{~g}$

Drikke: ett glass appelsinjuice ($200 \mathrm{~g}$)

![Frokost. Kilde: Privat (Udir)](/img/user/_resources/1pyhs-v23-2-3.jpeg){width=50%}

Beboeren drikker ett glass med $200 \mathrm{~g}$ appelsinjuice til frokost.

>[!oppgave]
>b) Bruk informasjon fra tabellen om energiinnholdet i $100 \mathrm{~g}$ matvare til å bestemme hvor mange kilokalorier (kcal) det er i juicen som beboeren drikker.
>c) Gjør utregninger for energiinnholdet i frokosten til beboeren. Lag en oversikt som viser energiinnholdet (kcal) per matvare og totalt energiinnhold (kcal) for hele frokosten.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/ludvigs-dusjregnskap/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/martines-studielan/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
