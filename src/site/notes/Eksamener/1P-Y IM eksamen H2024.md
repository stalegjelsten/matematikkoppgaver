---
{"tags":["eksamen"],"fag":["1p-y im"],"eksamen":"h24","date":"2024-11-25","del1_tid":1,"del2_tid":3,"title":"1P-Y IM eksamen H2024","author":"matematikkoppgaver.vercel.app","dg-publish":true,"showheader":true,"contentClasses":"eksamen-side","dg-permalink":"/eksamener/1p-y-im-eksamen-h2024/","permalink":"/eksamener/1p-y-im-eksamen-h2024/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["eksamen"],"fag":["1p-y im"],"eksamen":"h24","date":"2024-11-25","del1_tid":1,"del2_tid":3,"title":"1P-Y IM eksamen H2024","author":"matematikkoppgaver.vercel.app","showheader":true,"contentClasses":"eksamen-side"}}
---
...
| [1-4](#oppgave-1-4) | [Lykkehjul med sektorer og trekanter](https://matematikkoppgaver.vercel.app/lykkehjul-med-sektorer-og-trekanter/) | geometri, areal, omkrets | × |
| [1-5](#oppgave-1-5) | [Symmetri i logo](https://matematikkoppgaver.vercel.app/symmetri-i-logo/) | geometri | × |
...
| **№** | **Navn** | **Temaer** | **LF** |
| :--: | :--------------------------- | :------------------------ | :--: |
| [2-1](#oppgave-2-1) | [Mediebedrift og reklamevideo](https://matematikkoppgaver.vercel.app/mediebedrift-og-reklamevideo/) | økonomi, regneark, prosentregning | × |
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/lykkehjul-med-sektorer-og-trekanter/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Lykkehjul med sektorer og trekanter

Anne har fått i oppgave å designe et lykkehjul. Hun lager dette designet:

![Lykkehjul](/img/user/_resources/1pyim-h24-1-4.jpeg){width=60%}

Designet består av fire lysegrå sirkelsektorer med radius 4 dm og fire mørkegrå trekanter, slik at vinkel a og vinkel b er like store. Alle mål på figuren er i desimeter.

>[!oppgave]
>a) Beregn omkretsen av én trekant. Oppgi svaret i centimeter.
>b) Hvor mange grader er vinkel a? Husk å begrunne svaret ditt.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/symmetri-i-logo/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
En elev har fått i oppgave å se etter rotasjons- og speilingssymmetri i logoen nedenfor.

![Logo](/img/user/_resources/1pyim-h24-1-5.jpeg){width=40%}

Eleven stiller seg noen spørsmål:

>[!blue-box]
>Hvordan kan jeg lage en skisse med markeringer som viser om logoen har speilingssymmetri?

>[!green-box]
>Dersom den er rotasjonssymmetrisk, hvordan finner jeg rotasjonsvinkelen eller rotasjonsvinklene?

>[!oppgave]
>Gjør vurderinger og svar på spørsmålene til eleven.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/mediebedrift-og-reklamevideo/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Mediebedrift og reklamevideo

En mediebedrift skal produsere en reklamevideo og trenger et budsjett for å holde oversikt over kostnadene sine og sikre at prosjektet er lønnsomt.

Nedenfor ser du en tabell som viser utgiftspostene til mediebedriften.

| Utgiftsposter | Beskrivelse |
|---|---|
| Lønn til ansatte | Fem ansatte, alle jobber 40 timer hver, timelønn 400 kr |
| Leie av kamera- og lydutstyr | 1500 kr per dag, i tre dager |
| Leie av studio | 5000 kr per dag, i to dager |
| Redigering | Fastpris frilanser, 10 000 kr |

Mediebedriften får 120 000 kr i betaling når reklamefilmen er ferdig.

>[!oppgave]
>a) Sett opp et regneark som viser kostnader og inntekter for prosjektet.
>b) Utvid regnearket og vurder om prosjektet er lønnsomt hvis timelønnen til de ansatte må økes med 15 %.

Bedriften velger å beholde timelønnen på 400 kr, men prosjektet viser seg å være mer komplisert enn først antatt.

- bedriften må ansette én person ekstra som jobber 30 timer
- studioet må leies to dager ekstra
- kamera og lydutstyr må leies i fem dager i stedet for tre dager

>[!oppgave]
>c) Vurder hvordan disse endringene påvirker lønnsomheten i prosjektet.
