---
{"tags":["eksamen"],"fag":["1p-y ba"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y BA eksamen V2023","author":"matematikkoppgaver.vercel.app","dg-publish":true,"showheader":true,"contentClasses":"eksamen-side","dg-permalink":"/eksamener/1p-y-ba-eksamen-v2023/","permalink":"/eksamener/1p-y-ba-eksamen-v2023/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["eksamen"],"fag":["1p-y ba"],"eksamen":"v23","date":"2023-05-26","del1_tid":"None","del2_tid":"None","title":"1P-Y BA eksamen V2023","author":"matematikkoppgaver.vercel.app","showheader":true,"contentClasses":"eksamen-side"}}
---
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/lasermaling-og-malestokk/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Lasermåling og målestokk

Bildet under viser en lasermåling av avstanden mellom to yttervegger i et hus.

![Lasermåler](/img/user/_resources/1pyba-v23-1-4-1.jpeg){width=40%}

>[!oppgave]
>a) Les av lasermålingen og oppgi lengden i mm.
>b) Hvor stor blir feilmålingen hvis du bare leser av hele cm på lasermålingen?

![Fasade mot SØR](/img/user/_resources/1pyba-v23-1-4-2.jpeg){width=60%}

Tegningen over viser fasaden av et bygg.

Nora får oppgitt at målestokken på tegningen er $1:50$. Hun måler veggen med et målbånd som viser at veggen er $8000 \mathrm{~mm}$ lang. Når hun måler tegningen med linjal, er veggen $16 \mathrm{~cm}$ lang.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/endevegg-hus-areal-og-takvinkel/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
![Endevegg på hus](/img/user/_resources/1pyba-v23-2-1.jpeg){width=60%}

Tegningen over viser endeveggen på et hus. Tallene i tegningen er lengder oppgitt i meter.

>[!oppgave]
>a) Finn arealet av **hele** endeveggen og oppgi svaret i $\mathrm{m^2}$.
>b) Finn lengden av den **ene siden** av taket.
>c) Bruk trigonometri til å regne ut takvinkelen.
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/terrassebygning-og-pristilbud/" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">





# Terrassebygning og pristilbud

![Terrasse](/img/user/_resources/1pyba-v23-2-2.jpeg){width=60%}
...
- terrassebord $21 \times 98 \mathrm{~mm}$: $18{,}80 \mathrm{~kr}$ per meter
- bjelker $48 \times 98 \mathrm{~mm}$: $38{,}70 \mathrm{~kr}$ per meter
- terrasseskruer $4{,}2 \times 55$: $168 \mathrm{~kr}$ per eske

**Materialbehov for hver terrasse**

- terrassebord $21 \times 98 \mathrm{~mm}$: $100$ meter $+ 10 \%$ kapp
- bjelker $48 \times 98 \mathrm{~mm}$: $30$ meter $+ 10 \%$ kapp
- terrasseskruer: 2 esker

>[!oppgave]
>a) Lag et regneark for ungdomsbedriften *Best* som gir oversikt over materialkostnader for de 15 terrassene.
