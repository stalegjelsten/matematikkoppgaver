---
{"tags":["oppgave"],"date":"2026-03-15","modified":"2026-03-15","aliases":[],"dg-publish":true,"temaer":["statistikk","kumulativ frekvens","sentralmål","spredningsmål"],"fag":["2p-y","2p"],"eksamen":"v24","del":2,"oppgave":3,"poeng":4,"oppgavenummer":[{"fag":"2p-y","del":2,"oppgave":3},{"fag":"2p","del":2,"oppgave":2}],"title":"Skiturstatistikk Solveig og Miriam","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":2,"beskrivelse":"Sammenligne gjennomsnitt og standardavvik med venninne via Excel, og lese antall felles turer ut av kumulative frekvenser.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regne gjennomsnitt og standardavvik i Excel og sammenligne med oppgitte verdier for venninnen."},{"deloppgave":"b","beskrivelse":"Regne differanser i kumulative frekvenser og sammenligne med Solveigs råtall for å avgjøre påstander."}],"disabled rules":["format-tags-in-yaml","format-yaml-array","insert-yaml-attributes","move-tags-to-yaml","remove-yaml-keys","yaml-key-sort","file-name-heading","yaml-title","emphasis-style"],"dg-permalink":"/skiturstatistikk-solveig-og-miriam/","permalink":"/skiturstatistikk-solveig-og-miriam/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2026-03-15","modified":"2026-03-15","aliases":[],"temaer":["statistikk","kumulativ frekvens","sentralmål","spredningsmål"],"fag":["2p-y","2p"],"eksamen":"v24","del":2,"oppgave":3,"poeng":4,"oppgavenummer":[{"fag":"2p-y","del":2,"oppgave":3},{"fag":"2p","del":2,"oppgave":2}],"title":"Skiturstatistikk Solveig og Miriam","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":2,"beskrivelse":"Sammenligne gjennomsnitt og standardavvik med venninne via Excel, og lese antall felles turer ut av kumulative frekvenser.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regne gjennomsnitt og standardavvik i Excel og sammenligne med oppgitte verdier for venninnen."},{"deloppgave":"b","beskrivelse":"Regne differanser i kumulative frekvenser og sammenligne med Solveigs råtall for å avgjøre påstander."}],"disabled rules":["format-tags-in-yaml","format-yaml-array","insert-yaml-attributes","move-tags-to-yaml","remove-yaml-keys","yaml-key-sort","file-name-heading","yaml-title","emphasis-style"]}}
---
