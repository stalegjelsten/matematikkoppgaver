---
{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":null,"dg-publish":true,"temaer":["normalfordeling","simulering","programmering","sannsynlighet"],"fag":["s2"],"eksamen":"v25","del":2,"oppgave":2,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":2}],"title":"Normalfordelt hoppkonkurranse","source":"Eksamen S2 vår 2025","todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Tre uavhengig normalfordelte hoppere: halesannsynligheter, kombinasjon via multiplikasjonsprinsippet, og simulering av hvem som hopper lengst.","deloppgaver":[{"deloppgave":"a","kategori":1,"vanskegrad":1,"beskrivelse":"Beregne $P(X>90)$ for hver hopper i sannsynlighetsvinduet."},{"deloppgave":"b","beskrivelse":"$P(\\text{Maren vinner}|M=83) = P(B<83)\\cdot P(E<83)$ ved uavhengighet."},{"deloppgave":"c","beskrivelse":"Python-simulering med `gauss` for hver hopper; telle gunstige hvor $M>B$ og $M>E$."}],"dg-permalink":"/normalfordelt-hoppkonkurranse/","permalink":"/normalfordelt-hoppkonkurranse/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":null,"temaer":["normalfordeling","simulering","programmering","sannsynlighet"],"fag":["s2"],"eksamen":"v25","del":2,"oppgave":2,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":2}],"title":"Normalfordelt hoppkonkurranse","source":"Eksamen S2 vår 2025","todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Tre uavhengig normalfordelte hoppere: halesannsynligheter, kombinasjon via multiplikasjonsprinsippet, og simulering av hvem som hopper lengst.","deloppgaver":[{"deloppgave":"a","kategori":1,"vanskegrad":1,"beskrivelse":"Beregne $P(X>90)$ for hver hopper i sannsynlighetsvinduet."},{"deloppgave":"b","beskrivelse":"$P(\\text{Maren vinner}|M=83) = P(B<83)\\cdot P(E<83)$ ved uavhengighet."},{"deloppgave":"c","beskrivelse":"Python-simulering med `gauss` for hver hopper; telle gunstige hvor $M>B$ og $M>E$."}]}}
---
