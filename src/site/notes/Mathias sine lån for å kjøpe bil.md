---
{"tags":["oppgave"],"date":null,"modified":null,"aliases":null,"dg-publish":true,"temaer":["lån","rekker","annuitetslån","økonomi"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":4,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":4}],"title":"Mathias sine lån for å kjøpe bil Mathias sine lån for å kjøpe bil","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Annuitetslån som sum av diskonterte terminbeløp; bestemme terminbeløp, rentesats og total rentekostnad i CAS.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Løse $\\sum_{i=1}^8 T/1{,}04^i = 357\\,000$ i CAS for terminbeløp $T$."},{"deloppgave":"b","beskrivelse":"Løse $\\sum_{i=1}^{10} 52\\,000/k^i = 450\\,000$ for vekstfaktor $k$; rentesats = $k-1 = 2{,}72\\,\\%$."},{"deloppgave":"c","vanskegrad":1,"beskrivelse":"Sammenligne total rentekostnad = $\\sum T_i - \\text{pris}$ for begge lån."}],"dg-permalink":"/mathias-sine-lan-for-a-kjope-bil/","permalink":"/mathias-sine-lan-for-a-kjope-bil/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":null,"modified":null,"aliases":null,"temaer":["lån","rekker","annuitetslån","økonomi"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":4,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":4}],"title":"Mathias sine lån for å kjøpe bil Mathias sine lån for å kjøpe bil","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Annuitetslån som sum av diskonterte terminbeløp; bestemme terminbeløp, rentesats og total rentekostnad i CAS.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Løse $\\sum_{i=1}^8 T/1{,}04^i = 357\\,000$ i CAS for terminbeløp $T$."},{"deloppgave":"b","beskrivelse":"Løse $\\sum_{i=1}^{10} 52\\,000/k^i = 450\\,000$ for vekstfaktor $k$; rentesats = $k-1 = 2{,}72\\,\\%$."},{"deloppgave":"c","vanskegrad":1,"beskrivelse":"Sammenligne total rentekostnad = $\\sum T_i - \\text{pris}$ for begge lån."}]}}
---
