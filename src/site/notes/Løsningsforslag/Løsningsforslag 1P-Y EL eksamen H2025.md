...
b) Avdraget er $10\,000\mathrm{~kr}$ per termin, og lånet betales over 5 terminer:
...
b) Fra illustrasjonen er $CB = 1134\mathrm{~mm}$ hypotenusen i rettvinklet trekant $ACB$ med rett vinkel i $A$ og vinkel $35°$ ved $B$:

$$AB = 1134 \cdot \cos(35°) \approx \underline{\underline{929\mathrm{~mm}}}$$

$$AC = 1134 \cdot \sin(35°) \approx \underline{\underline{650\mathrm{~mm}}}$$

c) Areal per panel: $1{,}762 \cdot 1{,}134 \approx 1{,}998\mathrm{~m}^2$
