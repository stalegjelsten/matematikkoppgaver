---
{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":[],"dg-publish":true,"temaer":["regresjon","tolkning av integraler","samlet mengde","grenseinntekt og grensekostnad","derivasjon"],"fag":["s2"],"eksamen":"v25","del":2,"oppgave":1,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Grenseinntekt og grensekostnad på del 2","source":"Eksamen S2 vår 2025","todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Andregradsregresjon for kostnad; grenseinntekt og grensekostnad med tolkning, og tolke $\\int_{20}^{30} K'\\,dx = K(30)-K(20)$.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regresjon $K(x)=0{,}617x^2+25x+93{,}33$ og derivere for $K'(x)=1{,}23x+25$."},{"deloppgave":"b","beskrivelse":"Beregne $I'(35)=85{,}71$ og $K'(35)=68{,}19$; tolke differanse som ekstra fortjeneste per enhet."},{"deloppgave":"c","kategori":3,"beskrivelse":"Tolke $\\int_{20}^{30} K'(x)\\,dx = 558{,}5$ som differanse i produksjonskostnader mellom 20 og 30 enheter."}],"dg-permalink":"/grenseinntekt-og-grensekostnad-pa-del-2/","permalink":"/grenseinntekt-og-grensekostnad-pa-del-2/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":[],"temaer":["regresjon","tolkning av integraler","samlet mengde","grenseinntekt og grensekostnad","derivasjon"],"fag":["s2"],"eksamen":"v25","del":2,"oppgave":1,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Grenseinntekt og grensekostnad på del 2","source":"Eksamen S2 vår 2025","todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Andregradsregresjon for kostnad; grenseinntekt og grensekostnad med tolkning, og tolke $\\int_{20}^{30} K'\\,dx = K(30)-K(20)$.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regresjon $K(x)=0{,}617x^2+25x+93{,}33$ og derivere for $K'(x)=1{,}23x+25$."},{"deloppgave":"b","beskrivelse":"Beregne $I'(35)=85{,}71$ og $K'(35)=68{,}19$; tolke differanse som ekstra fortjeneste per enhet."},{"deloppgave":"c","kategori":3,"beskrivelse":"Tolke $\\int_{20}^{30} K'(x)\\,dx = 558{,}5$ som differanse i produksjonskostnader mellom 20 og 30 enheter."}]}}
---
