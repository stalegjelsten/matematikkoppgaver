---
{"tags":["oppgave"],"date":null,"modified":null,"aliases":null,"dg-publish":true,"temaer":["simulering","sannsynlighet","programmering","uendelig rekke","forventningsverdi"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":6,"poeng":4,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":6}],"title":"Simulering av antall terningkast for å få samme antall øyne i to kast på rad Simulering av antall terningkast for å få samme antall øyne i to kast på rad","source":null,"todo":null,"status":3,"kategori":3,"vanskegrad":3,"beskrivelse":"Argumentere for at summen av «sannsynlighet for at kastet er nødvendig» gir forventningsverdien; simulere samlet øynesum i Python.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Forklare at rekkesummen $1+1+5/6+(5/6)^2+\\ldots = 7$ gir forventningsverdien."},{"deloppgave":"b","kategori":2,"vanskegrad":2,"beskrivelse":"Simulere med nøstet while-løkke; estimere $\\text{E}(\\text{sum øyne}) \\approx 24{,}5$."}],"dg-permalink":"/simulering-av-antall-terningkast-for-a-fa-samme-antall-oyne-i-to-kast-pa-rad/","permalink":"/simulering-av-antall-terningkast-for-a-fa-samme-antall-oyne-i-to-kast-pa-rad/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":null,"modified":null,"aliases":null,"temaer":["simulering","sannsynlighet","programmering","uendelig rekke","forventningsverdi"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":6,"poeng":4,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":6}],"title":"Simulering av antall terningkast for å få samme antall øyne i to kast på rad Simulering av antall terningkast for å få samme antall øyne i to kast på rad","source":null,"todo":null,"status":3,"kategori":3,"vanskegrad":3,"beskrivelse":"Argumentere for at summen av «sannsynlighet for at kastet er nødvendig» gir forventningsverdien; simulere samlet øynesum i Python.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Forklare at rekkesummen $1+1+5/6+(5/6)^2+\\ldots = 7$ gir forventningsverdien."},{"deloppgave":"b","kategori":2,"vanskegrad":2,"beskrivelse":"Simulere med nøstet while-løkke; estimere $\\text{E}(\\text{sum øyne}) \\approx 24{,}5$."}]}}
---
