---
{"tags":["oppgave"],"date":"2024-12-04","modified":"2024-12-14","aliases":null,"dg-publish":true,"temaer":["logistisk funksjon","regresjon","samlet mengde","integral","derivasjon"],"fag":["s2"],"eksamen":"h24","del":2,"oppgave":"1","poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Marcos logistiske løpetrening","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Logistisk modell for løpedistanse: vise at modellen passer, finne vendepunkt med raskest vekst, og samlet km via bestemt integral + gjennomsnitt.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regresjon i GeoGebra og begrunne logistisk modell med øvre grense $\\sim 156$ km."},{"deloppgave":"b","beskrivelse":"Finne vendepunkt $t=10{,}43$ og $L'(10{,}43)\\approx 9{,}4$ km/uke."},{"deloppgave":"c","kategori":3,"vanskegrad":3,"beskrivelse":"Løse $\\int_0^b L(t)\\,dt=500$ for $b\\approx 11{,}19$ uker; gjennomsnitt = 500/$b$."}],"dg-permalink":"/marcos-logistiske-lopetrening/","permalink":"/marcos-logistiske-lopetrening/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2024-12-04","modified":"2024-12-14","aliases":null,"temaer":["logistisk funksjon","regresjon","samlet mengde","integral","derivasjon"],"fag":["s2"],"eksamen":"h24","del":2,"oppgave":"1","poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Marcos logistiske løpetrening","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Logistisk modell for løpedistanse: vise at modellen passer, finne vendepunkt med raskest vekst, og samlet km via bestemt integral + gjennomsnitt.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Regresjon i GeoGebra og begrunne logistisk modell med øvre grense $\\sim 156$ km."},{"deloppgave":"b","beskrivelse":"Finne vendepunkt $t=10{,}43$ og $L'(10{,}43)\\approx 9{,}4$ km/uke."},{"deloppgave":"c","kategori":3,"vanskegrad":3,"beskrivelse":"Løse $\\int_0^b L(t)\\,dt=500$ for $b\\approx 11{,}19$ uker; gjennomsnitt = 500/$b$."}]}}
---
