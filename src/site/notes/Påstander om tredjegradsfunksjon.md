---
{"tags":["oppgave"],"date":"2023-11-14","modified":"2026-04-22","aliases":[],"dg-publish":true,"temaer":["funksjonsdrøfting","derivasjon","argumentasjon"],"fag":["s1","r1"],"eksamen":"h23","del":2,"oppgave":6,"oppgavenummer":[{"fag":"s1","del":2,"oppgave":6},{"fag":"r1","del":2,"oppgave":3}],"poeng":null,"title":"Påstander om tredjegradsfunksjon","status":3,"source":null,"todo":null,"kategori":3,"vanskegrad":3,"beskrivelse":"Vurdere tre påstander om tredjegradsfunksjoner ved moteksempel ($x^3$), algebraisk bevis, og symbolsk derivering av generell form.","deloppgaver":[{"deloppgave":"a","vanskegrad":2,"beskrivelse":"Moteksempel $f(x) = x^3$ som viser at en tredjegradsfunksjon ikke trenger ekstremalpunkt."},{"deloppgave":"b","beskrivelse":"Skrive $f(x) = ax + b$ som tredjegradslikning; den har alltid minst én reell løsning."},{"deloppgave":"c","beskrivelse":"Dobbeltderivere $f(x) = cx^3 + dx^2 + mx + n$, løse $f''(3) = 0$ for $d$, og vise $f'(1) = f'(5)$."}],"dg-permalink":"/pastander-om-tredjegradsfunksjon/","permalink":"/pastander-om-tredjegradsfunksjon/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2023-11-14","modified":"2026-04-22","aliases":[],"temaer":["funksjonsdrøfting","derivasjon","argumentasjon"],"fag":["s1","r1"],"eksamen":"h23","del":2,"oppgave":6,"oppgavenummer":[{"fag":"s1","del":2,"oppgave":6},{"fag":"r1","del":2,"oppgave":3}],"poeng":null,"title":"Påstander om tredjegradsfunksjon","status":3,"source":null,"todo":null,"kategori":3,"vanskegrad":3,"beskrivelse":"Vurdere tre påstander om tredjegradsfunksjoner ved moteksempel ($x^3$), algebraisk bevis, og symbolsk derivering av generell form.","deloppgaver":[{"deloppgave":"a","vanskegrad":2,"beskrivelse":"Moteksempel $f(x) = x^3$ som viser at en tredjegradsfunksjon ikke trenger ekstremalpunkt."},{"deloppgave":"b","beskrivelse":"Skrive $f(x) = ax + b$ som tredjegradslikning; den har alltid minst én reell løsning."},{"deloppgave":"c","beskrivelse":"Dobbeltderivere $f(x) = cx^3 + dx^2 + mx + n$, løse $f''(3) = 0$ for $d$, og vise $f'(1) = f'(5)$."}]}}
---
