---
{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":null,"dg-publish":true,"temaer":["diskrete sannsynlighetsfordelinger","varians","forventningsverdi"],"fag":["s2"],"eksamen":"v25","del":1,"oppgave":3,"poeng":4,"oppgavenummer":[{"fag":"s2","del":1,"oppgave":3}],"title":"Sannsynlighetsfordeling til brettspill","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":1,"beskrivelse":"Fylle ut sannsynlighetsfordeling for spesiell terning (tre seksere), vise $\\text{E}(X)=4$ og beregne $\\text{Var}(X)=13/3$.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Fylle ut $P(X=k)$ i tabell og summere $\\sum k \\cdot P(X=k)=4$."},{"deloppgave":"b","kategori":1,"beskrivelse":"Summere $(k-\\mu)^2 \\cdot P(X=k)$ til $13/3$."}],"dg-permalink":"/sannsynlighetsfordeling-til-brettspill/","permalink":"/sannsynlighetsfordeling-til-brettspill/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-05-15","modified":"2025-05-15","aliases":null,"temaer":["diskrete sannsynlighetsfordelinger","varians","forventningsverdi"],"fag":["s2"],"eksamen":"v25","del":1,"oppgave":3,"poeng":4,"oppgavenummer":[{"fag":"s2","del":1,"oppgave":3}],"title":"Sannsynlighetsfordeling til brettspill","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":1,"beskrivelse":"Fylle ut sannsynlighetsfordeling for spesiell terning (tre seksere), vise $\\text{E}(X)=4$ og beregne $\\text{Var}(X)=13/3$.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Fylle ut $P(X=k)$ i tabell og summere $\\sum k \\cdot P(X=k)=4$."},{"deloppgave":"b","kategori":1,"beskrivelse":"Summere $(k-\\mu)^2 \\cdot P(X=k)$ til $13/3$."}]}}
---
