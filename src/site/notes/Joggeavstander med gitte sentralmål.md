---
{"tags":["oppgave"],"date":"2026-03-15","modified":"2026-03-15","aliases":[],"dg-publish":true,"temaer":["statistikk","sentralmål"],"fag":["2p-y"],"eksamen":"h23","del":1,"oppgave":4,"title":"Joggeavstander med gitte sentralmål","status":0,"source":null,"todo":null,"disabled rules":["format-tags-in-yaml","format-yaml-array","insert-yaml-attributes","move-tags-to-yaml","remove-yaml-keys","yaml-key-sort","file-name-heading","yaml-title","emphasis-style"],"permalink":"/joggeavstander-med-gitte-sentralmal/","dgPassFrontmatter":true}
---
