---
{"tags":["oppgave"],"date":"2024-11-20","modified":"2026-03-26","aliases":[],"dg-publish":true,"temaer":["rekker","uendelig rekke"],"fag":["r2"],"eksamen":"h24","del":1,"oppgave":2,"oppgavenummer":[{"fag":"r2","del":1,"oppgave":2}],"poeng":6,"title":"Sumformel, kvotient og geometrisk rekke","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":2,"beskrivelse":"Aritmetisk sumformel, kvotient fra sum av uendelig geometrisk rekke, og vis at $0{,}\\overline{75}=25/33$ som geometrisk rekke med $k=1/100$.","deloppgaver":[{"deloppgave":"a","kategori":1,"beskrivelse":"Finne $n=100$ og regne $s_{100}=(3+399)/2\\cdot 100=20\\,100$."},{"deloppgave":"b","kategori":1,"beskrivelse":"Løse $s=a_1/(1-k)$ for $k$: $k=1-12/18=1/3$."},{"deloppgave":"c","kategori":3,"beskrivelse":"Skriv $0{,}\\overline{75}$ som sum $\\sum 3/(4\\cdot 100^{i-1})$ og vis at $1{,}\\overline{75}=58/33$."}],"dg-permalink":"/sumformel-kvotient-og-geometrisk-rekke/","permalink":"/sumformel-kvotient-og-geometrisk-rekke/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2024-11-20","modified":"2026-03-26","aliases":[],"temaer":["rekker","uendelig rekke"],"fag":["r2"],"eksamen":"h24","del":1,"oppgave":2,"oppgavenummer":[{"fag":"r2","del":1,"oppgave":2}],"poeng":6,"title":"Sumformel, kvotient og geometrisk rekke","status":3,"source":null,"todo":null,"kategori":2,"vanskegrad":2,"beskrivelse":"Aritmetisk sumformel, kvotient fra sum av uendelig geometrisk rekke, og vis at $0{,}\\overline{75}=25/33$ som geometrisk rekke med $k=1/100$.","deloppgaver":[{"deloppgave":"a","kategori":1,"beskrivelse":"Finne $n=100$ og regne $s_{100}=(3+399)/2\\cdot 100=20\\,100$."},{"deloppgave":"b","kategori":1,"beskrivelse":"Løse $s=a_1/(1-k)$ for $k$: $k=1-12/18=1/3$."},{"deloppgave":"c","kategori":3,"beskrivelse":"Skriv $0{,}\\overline{75}$ som sum $\\sum 3/(4\\cdot 100^{i-1})$ og vis at $1{,}\\overline{75}=58/33$."}]}}
---
