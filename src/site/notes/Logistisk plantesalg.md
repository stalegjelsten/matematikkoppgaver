---
{"tags":["oppgave"],"date":"2025-11-22","modified":"2025-11-22","aliases":[],"dg-publish":true,"temaer":["regresjon","logistisk funksjon","tolkning av integraler","derivasjon","modellering"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":1,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Logistisk plantesalg","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Logistisk regresjon av salgsdata; vendepunkt via $I''=0$ og samlet inntekt via bestemt integral.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Logistisk regresjon i GeoGebra og vurdering av gyldighetsområde til $t \\in [0,7]$."},{"deloppgave":"b","beskrivelse":"Finne vendepunktet til $I(t)$ (uke 20) og beregne $I'(3) \\approx 9486$ kr/uke."},{"deloppgave":"c","beskrivelse":"Løse $\\int_0^x I(t)\\,dt = 65\\,000$ i CAS; tolke $x \\approx 4{,}3$ som uke 21."}],"dg-permalink":"/logistisk-plantesalg/","permalink":"/logistisk-plantesalg/","dgPassFrontmatter":true,"dg-note-properties":{"tags":["oppgave"],"date":"2025-11-22","modified":"2025-11-22","aliases":[],"temaer":["regresjon","logistisk funksjon","tolkning av integraler","derivasjon","modellering"],"fag":["s2"],"eksamen":"h25","del":2,"oppgave":1,"poeng":6,"oppgavenummer":[{"fag":"s2","del":2,"oppgave":1}],"title":"Logistisk plantesalg","source":null,"todo":null,"status":3,"kategori":2,"vanskegrad":2,"beskrivelse":"Logistisk regresjon av salgsdata; vendepunkt via $I''=0$ og samlet inntekt via bestemt integral.","deloppgaver":[{"deloppgave":"a","beskrivelse":"Logistisk regresjon i GeoGebra og vurdering av gyldighetsområde til $t \\in [0,7]$."},{"deloppgave":"b","beskrivelse":"Finne vendepunktet til $I(t)$ (uke 20) og beregne $I'(3) \\approx 9486$ kr/uke."},{"deloppgave":"c","beskrivelse":"Løse $\\int_0^x I(t)\\,dt = 65\\,000$ i CAS; tolke $x \\approx 4{,}3$ som uke 21."}]}}
---
